...
public class Report extends Controller
{
  ...
  public static void index()
  {
    ...
    List<Donation> uniqueDonations = getDonors(); // this used to extract set of users (no duplicates) in template
    render(donations, candidates, states, uniqueDonations);
  }

  /**
   * Filter donations byCandidate
   * 
  ...
  /**
   * Obtain a set of donors - no duplicates, i.e. unique list users This
   * achieved by collection of Donation objects where no duplicate donors, i.e.
   * a donor is present only once in the list of Donations. In other words, a
   * subset of all the donations is assembled such that each donor is present
   * once and once only.
   * 
